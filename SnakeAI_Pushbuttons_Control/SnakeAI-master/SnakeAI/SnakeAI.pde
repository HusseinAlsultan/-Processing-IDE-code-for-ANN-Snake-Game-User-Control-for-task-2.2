...
final int fps = 15;  //15 is ideal for self play, increasing for AI does not directly increase speed, speed is dependant on processing power
...
// for serial communication to play the game with pushbuttons
...
// For keyboard playing function uncommnet the section below
//void keyPressed() {
//  if (humanPlaying) {
//    if (key == CODED) {
//      switch(keyCode) {
